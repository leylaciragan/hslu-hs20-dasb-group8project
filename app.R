    ...
    tabsetPanel(
      tabPanel("Applications for asylum",
               ...
               tags$ol(
                 ...
                 tags$li("For usage in the time trend graph, the table was transposed to have the countries as columns instead of rows (see transposeAppli.py)."),
                 tags$li("Additionally, a timestamp was added to comply with the format requirements of the time trend graph (see appli_transposed.csv, transposeAppli.py)."),
               ),
               tags$b("Note: "),
               tags$p("Regarding step 4: We were unable to find a three-letter country code for East Germany. We used the code for Germany instead."),
      ...
      tabPanel("Map data",
               ...
               tags$ol(
                 ...
                 tags$li("Enrich data set with data from asylum applications data (source: AsylgesuchePerNation1986.csv, script: writeCountToGeoJson.py). "),
